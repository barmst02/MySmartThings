...
metadata {
	definition(name: "SmartSense [Temp] Multi Sensor", namespace: "smartthings", author: "SmartThings", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, mnmn: "SmartThings", vid: "generic-contact-2") {
	...
	tiles(scale: 2) {
		...
		main(["temperature", "status", "acceleration"])
