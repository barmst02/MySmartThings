...
metadata {
	...
	definition(name: "SmartPower [Power] Outlet", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.smartplug", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, mnmn: "SmartThings", vid: "generic-switch-power") {
		capability "Actuator"
		capability "Switch"
	...
	tiles(scale: 2) {
		...
		standardTile("power", "device.power", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
			state "default", label: '${currentValue} W', action: "", icon: "st.samsung.da.RC_ic_power",
            foregroundColor: "#000000",
                backgroundColors:[
					[value: 1, color: "#00cc00"], //Light Green
                	[value: 200, color: "#79b821"], //Darker Green
                	[value: 300, color: "#ffa81e"], //Orange
					[value: 400, color: "#FFF600"], //Yellow
                    [value: 500, color: "#fb1b42"] //Bright Red
				]
        }
